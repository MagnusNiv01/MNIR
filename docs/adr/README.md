...
- [`0004-canonical-persistence-and-round-trip.md`](0004-canonical-persistence-and-round-trip.md) — selects committed-lineage checkpoints, exact allocator-safe round-trip, deterministic CBOR with an explicit MNIR wire schema, and an isolated future `mnir-format` layer.
