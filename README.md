...
**Implemented through Function Calls and Sequencing Foundations 0.1**
...
```text
crates/
  mnir-core/    Canonical Program, type, Expression, Call, sequencing, and acyclic CFG model
