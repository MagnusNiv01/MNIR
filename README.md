...
**Implemented through Persistent Semantic Identity 0.1**
...
```text
crates/
  mnir-core/    Canonical Program, persistent identity, type, Expression, Call, sequencing, and acyclic CFG model
  mnir-verify/  Semantic verification V0.1–V0.4 and machine-readable diagnostics
